    ...
    <>
      <header className="glass" ref={headerRef}>
        ...
        <div className={`mobile-nav ${menuActive ? 'active' : ''}`}>
          <a href="#features" onClick={() => setMenuActive(false)}>Neural</a>
          <a href="#showcase" onClick={() => setMenuActive(false)}>Matrix</a>
          <a href="#timeline" onClick={() => setMenuActive(false)}>Evolution</a>
          <a href="#contact" onClick={() => setMenuActive(false)}>Connect</a>
